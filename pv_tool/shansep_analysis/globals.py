...
PIEKSTERKTE_COLUMNS = ['PV_NAAM', 'ALG__REGEL', 'ANA_TXT_MAX_VERTICALE_CONSOLIDATIE_SPANNING', 'TXT_SS_T_PIEK', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

EINDSTERKTE_COLUMNS = ['PV_NAAM', 'ALG__REGEL', 'ANA_TXT_MAX_VERTICALE_CONSOLIDATIE_SPANNING', 'TXT_SS_T_EIND', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']
...
PIEKSTERKTE_COLUMNS_DSS = ['PV_NAAM', 'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_MAX', 'ANA_DSS_CONSOLIDATIE_TYPE_REKEN', 'OCR_DSS', 'ANA_TERREINSPANNING']

EINDSTERKTE_COLUMNS_DSS = ['PV_NAAM', 'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_EIND', 'ANA_DSS_CONSOLIDATIE_TYPE_REKEN', 'OCR_DSS', 'ANA_TERREINSPANNING']
