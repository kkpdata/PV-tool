...
FIVE_PERC_COLUMNS_DSS = ['PV_NAAM',  'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_5%', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

TEN_PERC_COLUMNS_DSS = ['PV_NAAM',  'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_10%', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

FIFTEEN_PERC_COLUMNS_DSS = ['PV_NAAM',  'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_15%', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

TWENTY_PERC_COLUMNS_DSS = ['PV_NAAM', 'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_20%', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

PIEKSTERKTE_COLUMNS_DSS = ['PV_NAAM', 'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_BIJ_T_MAX', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']

EINDSTERKTE_COLUMNS_DSS = ['PV_NAAM', 'ALG__REGEL', 'ANA_DSS_MAX_CONSOLIDATIE_SPANNING', 'DSS_T_BIJ_T_EIND', 'ANA_TXT_CONSOLIDATIE_TYPE_REKEN', 'OCR_TXT', 'ANA_TERREINSPANNING']
