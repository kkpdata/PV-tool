...
def validate_alg(self: Validation):
    ...
    if not self.critical:
        ...
        return self.validate_with_schema("Algemene kenmerken", schema)
...
def validate_kenmerken_boring(self: Validation):
    ...
    return self.validate_with_schema("Kenmerken van de boring", schema)
...
def validate_monster(self: Validation):
    ...
    return self.validate_with_schema("Monster", schema)
...
def validate_clas(self: Validation):
    ...
    return self.validate_with_schema("Classificatie", schema)
...
def validate_crs(self: Validation):
    ...
    return self.validate_with_schema("Constant rate of strain proeven (CRS)", schema)
...
def validate_samendrukking(self: Validation):
    ...
    return self.validate_with_schema("Samendrukkingsproeven", schema)
...
def validate_dss(self: Validation):
    ...
    return self.validate_with_schema("DSS-proeven", schema)
...
def validate_triaxiaal(self: Validation):
    ...
    return self.validate_with_schema("Triaxiaalproeven single stage", schema)
